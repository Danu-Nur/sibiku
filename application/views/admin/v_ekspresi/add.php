	...
	<div class="x_panel">
		...
		<div class="col-md-3 col-sm-12 col-xs-12">
			...
			<div class="x_content" style="display: flex; justify-content: end;">
				<img src="<?= base_url('uploads/web/ekspresi.png') ?>" width="250px" alt="">
			</div>
			<!-- </div> -->
		</div>
		<div class="col-md-9 col-sm-12 col-xs-12">
			...
			<div class="x_content">
				<br />
				<form id="demo-form2" action="<?= site_url('Admin/Ekspresi/add') ?>" method="POST" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" id="nama_ekspresi" name="nama_ekspresi" required="required" class="form-control col-md-7 col-xs-12">
						</div>
					</div>
					<div class="form-group">
