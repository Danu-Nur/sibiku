...
class OrganTubuh extends CI_Controller
{
	private $_table = 'tb_organ_tubuh';
	private $idm = 'id';
	...
	public function index()
	{
		...
		$data = array(
			...
			'contents' => 'admin/v_organ_tubuh/index'
		);
	...
	public function add()
	{
		...
		if ($validation->run() == FALSE) {
			$data = array(
				'judul' => 'Tambah Data',
				'contents' => 'admin/v_organ_tubuh/add'
			);
			$this->load->view('templates/index', $data);
		} else {
			$config['upload_path'] = './uploads/videos/organ/';
	...
	public function edit($id = NULL)
	{
		...
		if (!isset($id)) redirect('admin/OrganTubuh');
		...
		$data = array(
			'judul' => 'Edit Data',
			'data' => $data_table,
			'contents' => 'admin/v_organ_tubuh/edit'
		);
	...
	public function update()
	{
		...
		if ($validation->run()) {
			...
			$old_video_path = './uploads/videos/organ/' . $existing_data['link_video'];
	...
	public function delete($id = NULL)
	{
		...
		$mdl = $this->m_codeigniter;
		$data_table = $mdl->getById($this->_table, $this->idm, $id);
		$video_path = './uploads/videos/organ/' . $data_table['link_video'];
